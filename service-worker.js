const CACHE = 'superapp-famille-v4-3-7-parametres-fiables-20260525-anticache';
const CORE_ASSETS = ['./', './index.html', './css/app.css?v=4.3.7', './js/app.js?v=4.3.7', './manifest.json?v=4.3.7'];
