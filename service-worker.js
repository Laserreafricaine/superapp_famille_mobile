const CACHE = 'superapp-famille-v4-3-3-filtres-actions-20260525-anticache';
const CORE_ASSETS = ['./', './index.html', './css/app.css?v=4.3.3', './js/app.js?v=4.3.3', './manifest.json?v=4.3.3'];
